...
export default function BizTrack() {
  ...
  useRegisterSW({
    ...
    onRegisterError(error) {
      // Not noise: no worker means no offline and no self-update, and the
      // update path is the only way a stuck build ever moves.
      console.warn('[BizTrack] service worker did not register', error)
    },
  });
